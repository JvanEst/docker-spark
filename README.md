# This repo is a _FORK_
This repo is forked from [big-data-europe/docker-spark](https://github.com/big-data-europe/docker-spark) and reconfigured to use centos instead of Alpine to make it easier to install pip modules (such as tensorflow)
